...
class FileFilterOptionPanel extends OptionsDialogPanel
	...
	static class FilterTableModel extends DefaultTableModel
		...
		public FilterTableModel(String fileTypeHeader, String filterHeader) {
			...
			addRow(new Object[] { "Fortran",			null }); styles[5]  = SYNTAX_STYLE_FORTRAN;
			addRow(new Object[] { "Groovy",			null }); styles[6]  = SYNTAX_STYLE_GROOVY;
			addRow(new Object[] { "HTML",				null }); styles[7]  = SYNTAX_STYLE_HTML;
			addRow(new Object[] { "Java",				null }); styles[8]  = SYNTAX_STYLE_JAVA;
			addRow(new Object[] { "JavaScript",		null }); styles[9]  = SYNTAX_STYLE_JAVASCRIPT;
			addRow(new Object[] { "JSP",				null }); styles[10] = SYNTAX_STYLE_JSP;
			addRow(new Object[] { "Lisp",				null }); styles[11] = SYNTAX_STYLE_LISP;
			addRow(new Object[] { "Lua",				null }); styles[12] = SYNTAX_STYLE_LUA;
			addRow(new Object[] { "Make",				null }); styles[13] = SYNTAX_STYLE_MAKEFILE;
			addRow(new Object[] { "Perl",				null }); styles[14] = SYNTAX_STYLE_PERL;
			addRow(new Object[] { "PHP",				null }); styles[15] = SYNTAX_STYLE_PHP;
			addRow(new Object[] { "Properties files",	null }); styles[16] = SYNTAX_STYLE_PROPERTIES_FILE;
			addRow(new Object[] { "Python",			null }); styles[17] = SYNTAX_STYLE_PYTHON;
			addRow(new Object[] { "Ruby",				null }); styles[18] = SYNTAX_STYLE_RUBY;
			addRow(new Object[] { "SAS",				null }); styles[19] = SYNTAX_STYLE_SAS;
			addRow(new Object[] { "SQL",				null }); styles[20] = SYNTAX_STYLE_SQL;
			addRow(new Object[] { "Tcl",				null }); styles[21] = SYNTAX_STYLE_TCL;
			addRow(new Object[] { "UNIX shell scripts",	null }); styles[22] = SYNTAX_STYLE_UNIX_SHELL;
			addRow(new Object[] { "Windows Batch",		null }); styles[23] = SYNTAX_STYLE_WINDOWS_BATCH;
			addRow(new Object[] { "XML",				null }); styles[24] = SYNTAX_STYLE_XML;
		}
