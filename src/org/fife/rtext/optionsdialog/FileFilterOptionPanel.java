...
//		box.add(Box.createVerticalGlue());
	...
	static class FilterTableModel extends DefaultTableModel
		...
		public FilterTableModel(String fileTypeHeader, String filterHeader) {
			...
			addRow(new Object[] { "LaTeX",				null }); styles[17] = SYNTAX_STYLE_LATEX;
			addRow(new Object[] { "Lisp",				null }); styles[18] = SYNTAX_STYLE_LISP;
			addRow(new Object[] { "Lua",				null }); styles[19] = SYNTAX_STYLE_LUA;
			addRow(new Object[] { "Make",				null }); styles[20] = SYNTAX_STYLE_MAKEFILE;
			addRow(new Object[] { "NSIS",				null }); styles[21] = SYNTAX_STYLE_NSIS;
			addRow(new Object[] { "Perl",				null }); styles[22] = SYNTAX_STYLE_PERL;
			addRow(new Object[] { "PHP",				null }); styles[23] = SYNTAX_STYLE_PHP;
			addRow(new Object[] { "Properties files",	null }); styles[24] = SYNTAX_STYLE_PROPERTIES_FILE;
			addRow(new Object[] { "Python",				null }); styles[25] = SYNTAX_STYLE_PYTHON;
			addRow(new Object[] { "Ruby",				null }); styles[26] = SYNTAX_STYLE_RUBY;
			addRow(new Object[] { "SAS",				null }); styles[27] = SYNTAX_STYLE_SAS;
			addRow(new Object[] { "Scala",				null }); styles[28] = SYNTAX_STYLE_SCALA;
			addRow(new Object[] { "SQL",				null }); styles[29] = SYNTAX_STYLE_SQL;
			addRow(new Object[] { "Tcl",				null }); styles[30] = SYNTAX_STYLE_TCL;
			addRow(new Object[] { "UNIX shell scripts",	null }); styles[31] = SYNTAX_STYLE_UNIX_SHELL;
			addRow(new Object[] { "Windows Batch",		null }); styles[32] = SYNTAX_STYLE_WINDOWS_BATCH;
			addRow(new Object[] { "XML",				null }); styles[33] = SYNTAX_STYLE_XML;
		}
