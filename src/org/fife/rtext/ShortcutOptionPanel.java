...
class ShortcutOptionPanel extends OptionsDialogPanel
	 ...
	 * data will be given focus and the user will be prompted to fix it.<p>
	 * This method always returns <code>null</code> (i.e., "OK"), as the user
	 * cannot enter invalid input into this panel.
	 * 
	 *
