...
class NewAction extends StandardAction {
	...
	/**
	 * Creates a new <code>NewAction</code>.
	 *
	 ...
	 */
	 public NewAction(RText owner, String text, Icon icon, String desc,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (mainView.currentTextArea != null) {
			mainView.currentTextArea.removeCaretListener(owner);
			mainView.currentTextArea.removeKeyListener(owner);
		}
